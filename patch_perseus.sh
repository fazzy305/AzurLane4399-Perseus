...
if [ ! -f "${bundle_id}.apk" ]; then
    ...
    case "${bundle_id}" in
        ...
        "com.bilibili.blhx.m4399")
            wget https://zz0w8-my.sharepoint.com/personal/mirage_zz0w8_onmicrosoft_com/_layouts/52/download.aspx?share=EVJqxORnpsNCrF_vc9bMZqMBNliF6m7SCSaoEdQxa1DUYw -O ${bundle_id}.apk -q
            ;;
